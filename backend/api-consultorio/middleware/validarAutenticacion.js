    ...
    if (req.headers.authorization && req.headers.authorization.startsWith("Bearer")) {
        try {
            ...
            req.usuario = await Usuario.findById(decode.id).select(
                "-correoUsuario -celularUsuario -direccionUsuario -generoUsuario -tipoDocumentoUsuario -documentoUsuario -edadUsuario -fechaNacimientoUsuario -claveAcceso -estadoUsuario -createdAt -updatedAt -__v -idCiudad -apellidosUsuario"
            );
